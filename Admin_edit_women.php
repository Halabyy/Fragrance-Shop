...
function getProducts() {
    global $conn;
    $result = $conn->query("SELECT * FROM products_women_test");
    $products = array();
...
function updateProduct($productId, $productName, $description, $price) {
    global $conn;
    $sql = "UPDATE products_women_test SET product_name=?, description=?, price=? WHERE product_id=?";
...
function deleteProduct($productId) {
    global $conn;
    $sql = "DELETE FROM products_women_test WHERE product_id=?";
    $stmt = $conn->prepare($sql);
